                        ...
                        @foreach ($categories as $category)
                            <tr class="bg-dark border-b dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <div class="flex space-x-2">
                                  <a href="{{route('admin.categories.edit', $category)}}" class="px-4 py-2 bg-green-500 hover:bg-green-700 rounded-lg ext-white">Edit</a>
                                    <form action="{{route('admin.categories.destroy', $category)}}"
                                        method="POST" class="px-4 py-2 bg-red-500 hover:bg-red-700 rounded-lg ext-white"
